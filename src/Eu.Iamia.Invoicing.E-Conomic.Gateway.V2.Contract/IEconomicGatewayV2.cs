...
public interface IEconomicGatewayV2
{
    ...
    Task<Contract.DTO.Invoices.booked.get.BookedInvoicesHandle> ReadBookedInvoices(int skipPages, int pageSize, IInterval<DateTime> daterange) => ReadBookedInvoices(skipPages, pageSize, daterange.From.ToEconomicDate(), daterange.To.ToEconomicDate());
